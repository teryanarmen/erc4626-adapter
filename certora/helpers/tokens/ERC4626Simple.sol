...
contract ERC4626Simple is ERC20 {
    ...
    function convertToShares(uint256 assets) public view virtual returns (uint256) {
        ...
        // simplify: return supply == 0 ? assets : assets.mulDivDown(supply, totalAssets());
        // the idea is to represent a 1:1 ratio or a 3 to 5 ratio. 
        return supply == 0 || !rateChange ? assets : assets * 3 / 5 ;
    ...
    function convertToAssets(uint256 shares) public view virtual returns (uint256) {
        ...
        // simplify : return supply == 0 ? shares : shares.mulDivDown(totalAssets(), supply);
        return supply == 0 || !rateChange ? shares : shares * 5 / 3 ;
    ...
    function previewMint(uint256 shares) public view virtual returns (uint256) {
        ...
        return supply == 0 || !rateChange ? shares : (shares * 5 + 2 )/ 3 ;
    }
    ...
    function previewWithdraw(uint256 assets) public view virtual returns (uint256) {
        ...
        return supply == 0 || !rateChange ? assets : (assets * 3 + 4) / 5 ;
    }
