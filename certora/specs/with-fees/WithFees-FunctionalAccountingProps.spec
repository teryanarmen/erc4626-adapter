import "./WithFees-MonotonicityInvariant.spec";

//Had to change _ERC20 to ___ERC20 as of import that already declares _ERC20. 
using ERC20 as ___ERC20;
...
methods {
    function ___ERC20.balanceOf(address) external returns uint256 envfree;
    function ___ERC20.transfer(address, uint256) external returns bool;
...
rule depositProperties(uint256 assets, address receiver, address user) {
    ...
    mathint ownerAssetsBefore = ___ERC20.balanceOf(user);
    ...
    mathint ownerAssetsAfter = ___ERC20.balanceOf(user);
...
rule withdrawProperties(uint256 assets, address receiver, address user) {
    ...
    mathint receiverAssetsBefore = ___ERC20.balanceOf(receiver);
    ...
    mathint receiverAssetsAfter = ___ERC20.balanceOf(receiver);
